    ...
    public class TradeTransactionBusiness
    {
        ...
        public async Task<IGiveandtakeResult> CancelTradeTransaction(int tradeTransactionId, int loggedInAccountId)
        {
            ...
            if (tradeTransaction == null)
            {
                ...
                {
                    Status = -1,
                    Message = "Không tìm thấy giao dịch trao đổi."
                };
            }
            ...
            if (tradeTransactionDetail == null || tradeTransactionDetail.RequestDonation == null)
            {
                ...
                {
                    Status = -1,
                    Message = "Không tìm thấy chi tiết của giao dịch trao đổi."
                };
            }
            ...
            if (requestDonation.AccountId != loggedInAccountId && tradeDonation.AccountId != loggedInAccountId)
            {
                ...
                {
                    Status = -1,
                    Message = "Bạn không có quyền huỷ giao dịch trao đổi này."
                };
            }
            ...
            if (tradeTransaction.Status == "Completed")
            {
                ...
                {
                    Status = -1,
                    Message = "Giao dịch trao đổi đã hoàn thành rồi thì không huỷ được."
                };
            }
            ...
            if (tradeTransaction.Status == "Cancelled")
            {
                ...
                {
                    Status = -1,
                    Message = "Giao dịch trao đổi này đã bị huỷ rồi."
                };
            }
            ...
            if (daysSinceCreation.HasValue && daysSinceCreation < 5)
            {
                ...
                {
                    Status = -1,
                    Message = $"Giao dịch trao đổi chỉ có thể bị huỷ sau 5 ngày kể từ ngày tạo. Xin hãy chờ thêm {daysRemaining} ngày nữa."
                };
            }
            ...
            {
                Status = 1,
                Message = "Giao dịch trao đổi đã được huỷ thành công. 2 món đồ đã được gửi về kho mỗi người.",
            };
        }
